...
local getcustomassets = {
	['fart/assets/liquidbounce/blatant.png'] = 'rbxasset://liquidbounce/blatant.png',
	['fart/assets/liquidbounce/combat.png'] = 'rbxasset://liquidbounce/combat.png',
	['fart/assets/liquidbounce/expand.png'] = 'rbxasset://liquidbounce/expand.png',
	['fart/assets/liquidbounce/inventory.png'] = 'rbxasset://liquidbounce/inventory.png',
	['fart/assets/liquidbounce/logo.png'] = 'rbxasset://liquidbounce/logo.png',
	['fart/assets/liquidbounce/minigames.png'] = 'rbxasset://liquidbounce/minigames.png',
	['fart/assets/liquidbounce/render.png'] = 'rbxasset://liquidbounce/render.png',
	['fart/assets/liquidbounce/textgui.png'] = 'rbxasset://liquidbounce/textgui.png',
	['fart/assets/liquidbounce/utility.png'] = 'rbxasset://liquidbounce/utility.png',
	['fart/assets/liquidbounce/world.png'] = 'rbxasset://liquidbounce/world.png',
...
local function writeFont()
	...
	--[[writefile('fart/assets/liquidbounce/lbfont.json', httpService:JSONEncode({
		name = 'Inter',
		faces = {
			{style = 'normal', assetId = getcustomasset('fart/assets/liquidbounce/Inter-Light.ttf'), name = 'Light', weight = 300},
			{style = 'normal', assetId = getcustomasset('fart/assets/liquidbounce/Inter-Regular.ttf'), name = 'Regular', weight = 400},
			{style = 'normal', assetId = getcustomasset('fart/assets/liquidbounce/Inter-Medium.ttf'), name = 'Medium', weight = 500}
		}
	}))]]
	return getcustomasset('fart/assets/liquidbounce/lbfont.json')
end
...
components = {
	...
	Dropdown = function(optionsettings, children, api)
		...
		dropdownexpand.Image = getcustomasset('fart/assets/liquidbounce/expand.png')
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		expandicon.Image = getcustomasset('fart/assets/liquidbounce/expand.png')
...
mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('fart/assets/liquidbounce/combat.png'),
	Size = UDim2.fromOffset(16, 15)
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('fart/assets/liquidbounce/blatant.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('fart/assets/liquidbounce/render.png'),
	Size = UDim2.fromOffset(15, 9)
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('fart/assets/liquidbounce/utility.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('fart/assets/liquidbounce/world.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('fart/assets/liquidbounce/inventory.png'),
	Size = UDim2.fromOffset(14, 15)
})
mainapi:CreateCategory({
	Name = 'Minigames',
	Icon = getcustomasset('fart/assets/liquidbounce/minigames.png'),
	Size = UDim2.fromOffset(15, 15)
})

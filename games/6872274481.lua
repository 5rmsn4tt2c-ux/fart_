                                    ...
                                    if staff then
                                        ...
                                        if projmeta then
                                            ...
                                            if calc then
                                                ...
                                                bedwars.ProjectileController:createLocalProjectile(itemMeta, projectile, projectile, shootPosition, id, sdir * projSpeed, {drawDurationSeconds = 0.85})
                                                local res = projectileRemote:InvokeServer(
                                                    staff.tool,
                                                    projectile,
                                                    projectile,
